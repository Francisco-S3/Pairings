      ...
      drawer: Drawer(
        ...
        child: ListView(
          children: <Widget>[
            ...
            // TODO - add deactivate toggle if not logged in
            // TODO - if(!globals.isLoggedIn){}
            // listTile for edit profile screen
            ListTile(
                title: const Text("Edit Profile"),
                trailing: const Icon(Icons.account_circle, color: Colors.white),
                onTap: () {
                  Navigator.of(context).pop();
                  Navigator.of(context).push(MaterialPageRoute(
